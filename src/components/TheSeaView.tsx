...
export const TheSeaView: React.FC<TheSeaViewProps> = ({
  ...
  return (
    <div className="relative w-full h-[62dvh] sm:h-[500px] min-h-[380px] rounded-2xl sm:rounded-3xl overflow-hidden border-4 sm:border-8 border-[#451a03] shadow-2xl select-none group">
      ...
      <div className="absolute top-2 sm:top-3 left-2 sm:left-3 right-2 sm:right-3 z-30 flex items-center justify-between gap-1.5 pointer-events-none">
        ...
        {/* Server Name Badge */}
        <div className="bg-[#451a03]/95 border sm:border-2 border-[#b45309] backdrop-blur-md px-2 py-1 sm:px-3 sm:py-1.5 rounded-xl sm:rounded-2xl text-white shadow-xl flex items-center gap-1.5 pointer-events-auto">
        ...
        <div className="flex items-center gap-1.5 pointer-events-auto">
          ...
          <button
            ...
            className="bg-[#b45309] hover:bg-[#d97706] border-b-2 sm:border-b-4 border-r border-[#451a03] text-white px-2 py-1 sm:px-3 sm:py-1.5 rounded-lg sm:rounded-xl text-[10px] sm:text-xs font-black uppercase italic shadow-2xl flex items-center gap-1 active:translate-y-0.5"
          >
      ...
      {battleResult && (
        <div className="absolute inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-4">
          <div className="bg-[#451a03] border-4 border-[#b45309] rounded-2xl p-5 text-center space-y-4 animate-fade-in shadow-2xl max-w-sm w-full text-amber-100">
            ...
            <div className="bg-[#1c0a02] border-2 border-[#78350f] rounded-xl p-3 grid grid-cols-2 gap-2 text-center">
              <div>
            ...
            <div className="bg-[#1c0a02] border-2 border-[#b45309] rounded-xl p-3 space-y-2">
              <div className="text-xs font-black uppercase text-[#fde68a] font-serif">Plundered Loot:</div>
              <div className="flex items-center justify-center gap-3">
                <div className="flex items-center gap-1 bg-[#78350f] border-2 border-[#b45309] px-3 py-1 rounded-xl text-[#fbbf24] font-black text-xs">
                  <span>🪙</span>
              ...
              {battleResult.cannonLooted && (
                <div className="bg-[#16a34a] border-2 border-[#064e3b] p-2 rounded-xl flex items-center justify-center gap-1.5 text-white text-[10px] font-black uppercase">
            ...
            <button
              ...
              className="w-full bg-[#b45309] hover:bg-[#d97706] border-b-4 border-r-2 border-[#451a03] text-white font-black py-2.5 rounded-xl uppercase italic tracking-wider text-xs shadow-xl active:translate-y-1"
            >
      ...
      {selectedShip && !battleResult && !isFiringSalvo && (
        <div className="absolute bottom-4 left-4 right-4 z-40 max-w-md mx-auto bg-[#78350f] border-4 border-[#451a03] rounded-2xl p-3 shadow-2xl text-amber-100 animate-fade-in">
          <div className="flex justify-between items-center border-b-2 border-[#b45309] pb-1.5 mb-2">
            ...
            <button
              ...
              className="text-xs font-black bg-[#451a03] border border-[#b45309] text-[#fde68a] px-2 py-0.5 rounded-lg"
            >
              ✕
            </button>
          </div>
          ...
          <div className="grid grid-cols-2 gap-2 text-xs font-mono mb-2">
            <div className="bg-[#1c0a02] p-1.5 rounded-xl border border-[#78350f]">
  ...
  return (
    ...
    >
      ...
      <div className="absolute -top-8 sm:-top-10 left-1/2 -translate-x-1/2 whitespace-nowrap flex flex-col items-center pointer-events-none z-30">
        <div
          className={`px-1.5 py-0.5 rounded-md text-[9px] sm:text-[10px] font-black font-serif shadow-lg border ${
            ship.isPlayer
              ? 'bg-[#16a34a] border-[#064e3b] text-white'
              : isSelected
              ? 'bg-[#b45309] border-[#facc15] text-[#fde68a]'
              : 'bg-[#451a03]/90 border-[#78350f] text-white'
          }`}
        >
          {ship.name}
        </div>
        ...
        {/* Mini HP Bar */}
        <div className="w-10 sm:w-14 bg-[#1c0a02] h-1 sm:h-1.5 rounded-full overflow-hidden border border-[#78350f] mt-0.5">
          <div
            className={`h-full ${
      ...
      >
        ...
        {ship.cannonCount > 0 && (
          <div className="absolute -bottom-1 -right-1 bg-[#1c0a02] border border-[#b45309] rounded p-0.5 text-[8px] font-black text-[#fbbf24] z-20">
            x{ship.cannonCount}
          </div>
        )}
      </div>
