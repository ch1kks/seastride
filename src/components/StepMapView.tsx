...
export const StepMapView: React.FC<StepMapViewProps> = () => {
  ...
  return (
    <div className="relative w-full h-[62dvh] sm:h-[480px] min-h-[360px] rounded-xl sm:rounded-2xl overflow-hidden border-2 sm:border-4 border-[#451a03] shadow-2xl flex flex-col select-none group bg-[#1c0a02]">
      ...
      <div className="absolute top-2 left-2 right-2 z-30 flex items-center justify-between gap-1.5 pointer-events-none">
        ...
        {/* Left Telemetry Card */}
        <div className="bg-[#451a03]/95 border border-[#b45309] backdrop-blur-md px-2.5 py-1 rounded-xl text-amber-100 shadow-xl flex items-center gap-2 pointer-events-auto">
          <div className="w-6 h-6 bg-[#78350f] rounded-lg flex items-center justify-center text-amber-300 border border-[#ca8a04]">
      ...
      <div className="absolute bottom-12 left-2 z-30 flex flex-col gap-1.5 pointer-events-auto">
        <button
          ...
          className={`p-2 rounded-xl border-2 shadow-xl flex items-center justify-center transition-all ${
            followCaptain
              ...
              : 'bg-[#451a03] border-[#b45309] text-[#fde68a] hover:bg-[#78350f]'
          }`}
        ...
        <button
          ...
          className="w-8 h-8 bg-[#451a03] hover:bg-[#78350f] border border-[#b45309] rounded-lg text-white font-black text-sm flex items-center justify-center shadow"
        >
          +
        </button>
        ...
        <button
          onClick={clearTrace}
          className="p-2 bg-[#451a03] hover:bg-[#78350f] border border-[#b45309] rounded-lg text-red-300 shadow"
      ...
      <div className="absolute bottom-12 right-2 z-30 pointer-events-auto">
        <button
          ...
          className="bg-[#d97706] hover:bg-[#f59e0b] active:scale-95 text-white font-serif font-black text-xs px-3 py-2 rounded-xl border-b-3 border-[#78350f] shadow-2xl flex items-center gap-1.5 uppercase italic"
        >
      ...
      <div className="absolute bottom-0 inset-x-0 z-30 bg-[#451a03]/95 border-t-2 border-[#78350f] px-2.5 py-1 flex items-center justify-between text-[9px] sm:text-[10px] font-mono text-[#fde68a] backdrop-blur-sm">
