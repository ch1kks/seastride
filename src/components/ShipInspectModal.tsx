    ...
    <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-3 select-none">
      <div className="bg-[#78350f] border-8 border-[#451a03] rounded-3xl w-full max-w-md overflow-hidden shadow-2xl relative text-amber-100 flex flex-col">
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="bg-[#451a03] border-4 border-[#b45309] rounded-2xl p-4 flex flex-col items-center relative overflow-hidden">
            <img
              src={shipImg}
              alt="Ship"
          ...
          {/* Condition Gauge */}
          <div className="bg-[#451a03] border-2 border-[#b45309] rounded-2xl p-3.5 space-y-1.5">
            ...
            <div className="w-full bg-[#1c0a02] h-3.5 rounded-full border border-[#78350f] overflow-hidden">
              <div
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="bg-[#451a03] border-2 border-[#b45309] p-3 rounded-2xl flex items-center gap-2.5">
              <img
                src={cannonImg}
                alt="Cannon"
                referrerPolicy="no-referrer"
          ...
          <div className="grid grid-cols-2 gap-2 pt-1">
            ...
            <button
              ...
              className="bg-[#b45309] hover:bg-[#d97706] border-b-4 border-r-2 border-[#451a03] text-white font-black py-2.5 rounded-xl text-xs uppercase italic shadow-md active:translate-y-0.5 flex items-center justify-center gap-1.5"
            >
